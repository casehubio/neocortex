...
cognitive-api/      — zero deps: Confidence record, ConfidenceOrigin enum, TemporalMark sealed hierarchy (WallClock, Relative, Ordinal), AffectType enum (INHERENT, ANTICIPATORY). Cross-cutting cognitive types shared by MindMap, Memory, and CBR subsystems.
