...
cognitive-api/      — zero deps: Confidence record, ConfidenceOrigin enum, TemporalMark sealed hierarchy (WallClock, Relative, Ordinal). Cross-cutting cognitive types shared by MindMap, Memory, and CBR subsystems.
