...
class ErasureNotificationCbrRecordStoreTest {
    ...
    private List<CbrRecordErased.ByRequest>       byRequestEvents;
    private List<CbrRecordErased.ByEntity>        byEntityEvents;
    private List<CbrRecordErased.ByScope>     byScopeEvents;
    private ErasureNotificationCbrRecordStore decorator;
    ...
    void setUp() {
        ...
        decorator = new ErasureNotificationCbrRecordStore(
                stub,
