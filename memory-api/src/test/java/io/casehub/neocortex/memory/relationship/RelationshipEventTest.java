...
class RelationshipEventTest {
    ...
    void requiresAgentId() {
        assertThrows(NullPointerException.class, () ->
            new RelationshipEvent(null, "b1", "t1", null, null, null, "action",
    ...
    void requiresOtherAgentId() {
        assertThrows(NullPointerException.class, () ->
            new RelationshipEvent("a1", null, "t1", null, null, null, "action",
                                  QualitySignal.NEUTRAL, "desc", null, Map.of()));
    }
    ...
    void requiresTenantId() {
        assertThrows(NullPointerException.class, () ->
            new RelationshipEvent("a1", "b1", null, null, null, null, "action",
                                  QualitySignal.NEUTRAL, "desc", null, Map.of()));
    }
    ...
    void requiresSourceEventType() {
        assertThrows(NullPointerException.class, () ->
            new RelationshipEvent("a1", "b1", "t1", null, null, null, null,
                                  QualitySignal.NEUTRAL, "desc", null, Map.of()));
    }
    ...
    void requiresQualitySignal() {
        assertThrows(NullPointerException.class, () ->
            new RelationshipEvent("a1", "b1", "t1", null, null, null, "action",
    ...
    void rejectsSelfReferential() {
        assertThrows(IllegalArgumentException.class, () ->
            new RelationshipEvent("a1", "a1", "t1", null, null, null, "action",
                                  QualitySignal.NEUTRAL, "desc", null, Map.of()));
    }
    ...
    void copiesMetadata() {
        ...
        var event = new RelationshipEvent("a1", "b1", "t1", null, null,
                                          null, "action", QualitySignal.NEUTRAL, "desc", null, mutable);
        mutable.put("k2", "v2");
    ...
    void validEventStoresAllFields() {
        var event = new RelationshipEvent("a1", "b1", "t1", "c1", "turn-1",
                                          null, "observation", QualitySignal.POSITIVE, "cooperated on review", 0.8,
                                          Map.of("extra", "val"));
