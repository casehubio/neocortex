...
class MemoryTest {
    ...
    void valid_memory_constructs() {
        var now = Instant.now();
        var m = new Memory("mem-1", "e1", DOMAIN, "t1", null, "text", Map.of(), now, null, null, null, null);
    ...
    void attributes_are_defensively_copied() {
        ...
        mutable.put("k", "v");
        var m = new Memory("id", "e1", DOMAIN, "t1", null, "text", mutable, Instant.now(), null, null, null, null);
        mutable.put("k2", "v2");
    ...
    void attributes_map_is_unmodifiable() {
        var m = new Memory("id", "e1", DOMAIN, "t1", null, "text",
                           Map.of("k", "v"), Instant.now(), null, null, null, null);
