...
class MoodStateTest {
    ...
    void requiresAgentId() {
        assertThrows(NullPointerException.class, () ->
            new MoodState(null, "t1", null, 0.0, 0.0, 0.0, "init", null, Map.of()));
    }

    @Test
    void requiresTenantId() {
        assertThrows(NullPointerException.class, () ->
            new MoodState("a1", null, null, 0.0, 0.0, 0.0, "init", null, Map.of()));
    }
    ...
    void rejectsBlankCause() {
        assertThrows(IllegalArgumentException.class, () ->
            new MoodState("a1", "t1", null, 0.0, 0.0, 0.0, "  ", null, Map.of()));
    }

    @Test
    void rejectsPleasureOutOfBounds() {
        assertThrows(IllegalArgumentException.class, () ->
            new MoodState("a1", "t1", null, 1.1, 0.0, 0.0, "init", null, Map.of()));
        assertThrows(IllegalArgumentException.class, () ->
            new MoodState("a1", "t1", null, -1.1, 0.0, 0.0, "init", null, Map.of()));
    }
    ...
    void rejectsArousalOutOfBounds() {
        assertThrows(IllegalArgumentException.class, () ->
            new MoodState("a1", "t1", null, 0.0, 1.1, 0.0, "init", null, Map.of()));
        assertThrows(IllegalArgumentException.class, () ->
            new MoodState("a1", "t1", null, 0.0, -1.1, 0.0, "init", null, Map.of()));
    }
    ...
    void rejectsDominanceOutOfBounds() {
        assertThrows(IllegalArgumentException.class, () ->
            new MoodState("a1", "t1", null, 0.0, 0.0, 1.1, "init", null, Map.of()));
        assertThrows(IllegalArgumentException.class, () ->
            new MoodState("a1", "t1", null, 0.0, 0.0, -1.1, "init", null, Map.of()));
    }
    ...
    void acceptsBoundaryValues() {
        var state = new MoodState("a1", "t1", null, 1.0, -1.0, 0.5, "event", "turn-1", Map.of());
    ...
    void copiesMetadata() {
        ...
        var state = new MoodState("a1", "t1", null, 0.0, 0.0, 0.0, "init", null, mutable);
        mutable.put("k2", "v2");
