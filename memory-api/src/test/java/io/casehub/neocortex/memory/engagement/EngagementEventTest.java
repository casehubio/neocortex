...
class EngagementEventTest {
    ...
    void requiresAgentId() {
        assertThrows(NullPointerException.class, () ->
            new EngagementEvent(null, "b1", "t1", null, "turn-1", null, "desc",
    ...
    void requiresOtherAgentId() {
        assertThrows(NullPointerException.class, () ->
            new EngagementEvent("a1", null, "t1", null, "turn-1", null, "desc",
                                null, Map.of(), true, null, null, null, null, null));
    }
    ...
    void requiresTenantId() {
        assertThrows(NullPointerException.class, () ->
            new EngagementEvent("a1", "b1", null, null, "turn-1", null, "desc",
                                null, Map.of(), true, null, null, null, null, null));
    }
    ...
    void requiresTurnId() {
        assertThrows(NullPointerException.class, () ->
            new EngagementEvent("a1", "b1", "t1", null, null, null, "desc",
                                null, Map.of(), true, null, null, null, null, null));
    }
    ...
    void requiresDescription() {
        assertThrows(NullPointerException.class, () ->
            new EngagementEvent("a1", "b1", "t1", null, "turn-1", null, null,
                                null, Map.of(), true, null, null, null, null, null));
    }
    ...
    void rejectsSelfReferential() {
        assertThrows(IllegalArgumentException.class, () ->
            new EngagementEvent("a1", "a1", "t1", null, "turn-1", null, "desc",
                                null, Map.of(), true, null, null, null, null, null));
    }
    ...
    void rejectsSentimentShiftOutOfBounds() {
        assertThrows(IllegalArgumentException.class, () ->
            new EngagementEvent("a1", "b1", "t1", null, "turn-1", null, "desc",
    ...
    void acceptsAllNullSignals() {
        var event = new EngagementEvent("a1", "b1", "t1", null, "turn-1", null, "desc",
    ...
    void validEventStoresAllFields() {
        var event = new EngagementEvent("a1", "b1", "t1", "c1", "turn-1",
                                        null, "user responded enthusiastically", 0.8, Map.of("extra", "val"),
