...
class ExperienceEventTest {
    ...
    void observationRequiresAgentId() {
        assertThrows(NullPointerException.class, () ->
            new Observation(null, "t1", null, null, "desc", null, Map.of(), "subj"));
    }

    @Test
    void observationRequiresTenantId() {
        assertThrows(NullPointerException.class, () ->
            new Observation("a1", null, null, null, "desc", null, Map.of(), "subj"));
    }
    ...
    void observationRejectsBlankDescription() {
        assertThrows(IllegalArgumentException.class, () ->
            new Observation("a1", "t1", null, null, "  ", null, Map.of(), "subj"));
    }

    @Test
    void observationRequiresSubject() {
        assertThrows(NullPointerException.class, () ->
            new Observation("a1", "t1", null, null, "desc", null, Map.of(), null));
    }

    @Test
    void observationRejectsBlankSubject() {
        assertThrows(IllegalArgumentException.class, () ->
            new Observation("a1", "t1", null, null, "desc", null, Map.of(), " "));
    }
    ...
    void observationCopiesMetadata() {
        ...
        var obs = new Observation("a1", "t1", null, null, "desc", null, mutable, "subj");
        mutable.put("k2", "v2");
    ...
    void observationRejectsInvalidConfidence() {
        ...
        assertThrows(IllegalArgumentException.class, () ->
            new Observation("a1", "t1", null, null, "desc", -0.1, Map.of(), "subj"));
    }

    @Test
    void observationImplementsExperienceEvent() {
        ExperienceEvent event = new Observation("a1", "t1", "c1", "turn-1", "saw it", 0.5, Map.of(), "PR #1");
    ...
    void actionAcceptsNullCapability() {
        var action = new Action("a1", "t1", null, null, "did it", null, Map.of(), null);
    ...
    void actionRequiresAgentIdAndDescription() {
        assertThrows(NullPointerException.class, () ->
            new Action(null, "t1", null, null, "desc", null, Map.of(), null));
        assertThrows(NullPointerException.class, () ->
            new Action("a1", "t1", null, null, null, null, Map.of(), null));
    }

    @Test
    void outcomeRequiresResult() {
        assertThrows(NullPointerException.class, () ->
            new Outcome("a1", "t1", null, null, "desc", null, Map.of(), null, null));
    }

    @Test
    void outcomeRejectsBlankResult() {
        assertThrows(IllegalArgumentException.class, () ->
            new Outcome("a1", "t1", null, null, "desc", null, Map.of(), " ", null));
    }

    @Test
    void outcomeAcceptsNullCapability() {
        var outcome = new Outcome("a1", "t1", null, null, "desc", null, Map.of(), "completed", null);
        assertNull(outcome.capability());
    }

    @Test
    void sealedHierarchyIsExhaustive() {
        ExperienceEvent obs = new Observation("a1", "t1", null, null, "desc", null, Map.of(), "subj");
        ExperienceEvent act = new Action("a1", "t1", null, null, "desc", null, Map.of(), "cap");
        ExperienceEvent out = new Outcome("a1", "t1", null, null, "desc", null, Map.of(), "ok", null);
