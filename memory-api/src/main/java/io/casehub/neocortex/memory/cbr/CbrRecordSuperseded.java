...
public sealed interface CbrRecordSuperseded {
    String tenantId();
    ...
    record ByCase(String tenantId, String caseId, String supersedingCaseId,
                  String reason, Instant supersededAt) implements CbrRecordSuperseded {
        public ByCase {
    ...
    record ByFilter(String tenantId, MemoryDomain domain, String caseType,
                    ...
                    int supersededCount, Instant supersededAt) implements CbrRecordSuperseded {
        public ByFilter {
            Objects.requireNonNull(tenantId, "tenantId");
    ...
    record ByIds(String tenantId, Collection<String> caseIds,
                 ...
                 Instant supersededAt) implements CbrRecordSuperseded {
        public ByIds {
            Objects.requireNonNull(tenantId, "tenantId");
