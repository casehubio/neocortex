...
public sealed interface CbrRecordReinstated {
    String tenantId();
    ...
    record ByCase(String tenantId, String caseId,
                  Instant reinstatedAt) implements CbrRecordReinstated {
        public ByCase {
    ...
    record ByFilter(String tenantId, MemoryDomain domain, String caseType,
                    ...
                    int reinstatedCount, Instant reinstatedAt) implements CbrRecordReinstated {
        public ByFilter {
            Objects.requireNonNull(tenantId, "tenantId");
