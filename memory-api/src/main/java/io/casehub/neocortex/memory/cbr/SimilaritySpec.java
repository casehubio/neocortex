...
public sealed interface SimilaritySpec permits SimilaritySpec.CategoricalTable,
                                               SimilaritySpec.GaussianDecay,
                                               SimilaritySpec.StepDecay,
                                               SimilaritySpec.ExponentialDecay,
                                               SimilaritySpec.DtwSpec,
                                               SimilaritySpec.EditDistanceSpec {
    ...
    record CategoricalTable(Map<String, Map<String, Double>> similarities) implements SimilaritySpec {
        public CategoricalTable {
            ...
            similarities = validateAndMirrorSimilarityMap(similarities);
        }
    }
