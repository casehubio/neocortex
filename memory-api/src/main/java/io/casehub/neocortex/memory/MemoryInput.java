...
public record MemoryInput(
    ...
    public MemoryInput withAttribute(String key, String value) {
        ...
        return new MemoryInput(entityId, domain, tenantId, caseId, text, merged, confidence);
    }
    ...
    public MemoryInput withText(String newText) {
        return new MemoryInput(entityId, domain, tenantId, caseId, newText, attributes, confidence);
    }
}
