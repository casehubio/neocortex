...
public final class LifeContractorDemo {
    ...
    static final List<SeedCase> SEED_CASES = List.of(
        new SeedCase(
            ...
            Map.of("job_type", "PLUMBING", "urgency", "ROUTINE", "property_area", "HVAC",
                   "cost_band", "100_250", "season", "WINTER",
                   "job_description", "Annual boiler service plus replacement of pressure valve")),
        new SeedCase(
            ...
            Map.of("job_type", "PLUMBING", "urgency", "ROUTINE", "property_area", "HVAC",
                   "cost_band", "100_250", "season", "WINTER",
                   "job_description", "Boiler intermittent ignition failure")),
        new SeedCase(
            ...
            Map.of("job_type", "PLUMBING", "urgency", "ROUTINE", "property_area", "HVAC",
                   "cost_band", "100_250", "season", "AUTUMN",
                   "job_description", "Boiler losing pressure")),
        new SeedCase(
            ...
            Map.of("job_type", "PLUMBING", "urgency", "ROUTINE", "property_area", "HVAC",
                   "cost_band", "100_250", "season", "WINTER",
                   "job_description", "Boiler service delayed by parts")),
        new SeedCase(
            ...
            Map.of("job_type", "PLUMBING", "urgency", "ROUTINE", "property_area", "KITCHEN",
                   "cost_band", "UNDER_100", "season", "SPRING",
                   "job_description", "Kitchen sink blockage")),
        new SeedCase(
            ...
            Map.of("job_type", "PLUMBING", "urgency", "ROUTINE", "property_area", "BATHROOM",
                   "cost_band", "100_250", "season", "SUMMER",
                   "job_description", "Shower mixer valve replacement")),
        new SeedCase(
            ...
            Map.of("job_type", "ELECTRICAL", "urgency", "ROUTINE", "property_area", "GENERAL",
                   "cost_band", "UNDER_100", "season", "SPRING",
                   "job_description", "Electrical socket replacement")),
        new SeedCase(
            ...
            Map.of("job_type", "ROOFING", "urgency", "PLANNED", "property_area", "EXTERIOR",
                   "cost_band", "250_500", "season", "AUTUMN",
                   "job_description", "Roof tile replacement after storm")),
        new SeedCase(
            ...
            Map.of("job_type", "APPLIANCE", "urgency", "PLANNED", "property_area", "KITCHEN",
                   "cost_band", "100_250", "season", "SUMMER",
                   "job_description", "Dishwasher installation")),
        new SeedCase(
            ...
            "EXCELLENT", 0.98,
            Map.of("job_type", "PLUMBING", "urgency", "EMERGENCY", "property_area", "GENERAL",
                   "cost_band", "250_500", "season", "WINTER",
                   "job_description", "Emergency boiler repair, no heating"))
    );
    ...
    public static List<Result> run(CbrCaseMemoryStore store) {
        ...
        var query = CbrQuery.of(TENANT, DOMAIN, CASE_TYPE,
            Map.of("job_type", "PLUMBING", "property_area", "HVAC"), 10);
