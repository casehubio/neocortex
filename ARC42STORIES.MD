...
**Version:** 0.1  
**Status:** C3 complete — SPI Foundation + Runtime Core delivered  
...
|---|---|---|---|
| J1 Neural Inference | Deliver the standalone ONNX inference layer — SPI, runtime, adapters, SPLADE, Quarkus wiring | C1–C6 | 🚧 In progress (C1–C3 complete) |
