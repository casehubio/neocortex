...
public class CaseEnrichmentPipeline implements CaseMemoryStore {

    private static final Logger LOG = Logger.getLogger(CaseEnrichmentPipeline.class.getName());

    private final CaseMemoryStore delegate;
    private final List<CaseEnrichmentStep> sortedSteps;

    public CaseEnrichmentPipeline(CaseMemoryStore delegate, List<CaseEnrichmentStep> steps) {
