...
class GraphitiCaseMemoryStoreTest {
    ...
    private MemoryInput input(final String text) {
        return new MemoryInput(ENTITY, DOMAIN, TENANT, null, text, Map.of(), null, null, null, null);
    }
    ...
    void store_sends_source_description_with_domain_and_caseId_when_caseId_present() {
        ...
        final var withCase = new MemoryInput(ENTITY, DOMAIN, TENANT, "case-99", "text", Map.of(), null, null, null, null);
    ...
    void store_tenant_mismatch_throws_before_http_call() {
        final var bad = new MemoryInput(ENTITY, DOMAIN, "wrong-tenant", null, "x", Map.of(), null, null, null, null);
    ...
    void storeAll_sends_sequential_posts_returns_ids_in_order() {
        ...
        final var b = new MemoryInput("actor-2", DOMAIN, TENANT, null, "fact b", Map.of(), null, null, null, null);
